...
# SDD Summary: 0005-score-basierter-ausgang [selected]

- Goal: Score-abhängige Abschluss-Nachricht in show_summary()
- Phase: close
- Task: none
- Progress: 1 done / 0 active / 0 pending / 0 blocked
...
- Next: graduate knowledge, finalize artifacts, or sdd reopen 0005-score-basierter-ausgang to extend
